        ...
        if request.method == 'GET':
            ...
            settings, created = RatedAppSettings.objects.get_or_create(
                defaults={
                    ...
                    'clinic_timezone': data.get('clinic_timezone', 'Australia/Sydney'),
                    'software_integration': data.get('software_integration', ''),
                    'api_key': data.get('api_key', '')
                }
            )
            
            if not created:
                settings.clinic_name = data.get('clinic_name')
                ...
                settings.software_integration = data.get('software_integration', settings.software_integration)
